...
INSERT INTO product(name, synopsis, price, discount, stock, author, editor, language, image) VALUES('The Jungle Book', 'A collection of stories by Rudyard Kipling. It follows the adventures of Mowgli, a boy raised by wolves in the Indian jungle.', 180, 20, 18, 'Rudyard Kipling', 'Macmillan Publishers', 'English', 'the_jungle_book.png');
INSERT INTO product_category(product_id, category_type) VALUES(41, 'children''s literature');
INSERT INTO product(name, synopsis, price, discount, stock, author, editor, language, image) VALUES('The Sun Also Rises', 'A novel by Ernest Hemingway. It explores the experiences of the "Lost Generation" after World War I.', 200, 15, 20, 'Ernest Hemingway', 'Scribner', 'English', 'the_sun_also_rises.png');
INSERT INTO product_category(product_id, category_type) VALUES(42, 'fiction');
INSERT INTO product(name, synopsis, price, discount, stock, author, editor, language, image) VALUES('The Secret Life of Bees', 'A novel by Sue Monk Kidd. It follows the journey of a young girl named Lily Owens as she searches for clues about her mother.', 220, 18, 15, 'Sue Monk Kidd', 'Viking Penguin', 'English', 'the_secret_life_of_bees.png');
INSERT INTO product_category(product_id, category_type) VALUES(43, 'drama');
INSERT INTO product(name, synopsis, price, discount, stock, author, editor, language, image) VALUES('The Road to Wigan Pier', 'A social and political report by George Orwell. It examines the bleak living conditions among the working-class in England during the 1930s.', 190, 22, 12, 'George Orwell', 'Gollancz', 'English', 'the_road_to_wigan_pier.png');
...
INSERT INTO product(name, synopsis, price, discount, stock, author, editor, language, image) VALUES('The Metamorphosis', 'A novella by Franz Kafka. It tells the story of Gregor Samsa, who wakes up one morning to find himself transformed into a giant insect.', 180, 20, 18, 'Franz Kafka', 'Kurt Wolff Verlag', 'German', 'the_metamorphosis.png');
INSERT INTO product_category(product_id, category_type) VALUES(46, 'classic');
INSERT INTO product(name, synopsis, price, discount, stock, author, editor, language, image) VALUES('The Glass Castle', 'A memoir by Jeannette Walls. It recounts the unconventional, poverty-stricken upbringing Walls and her siblings had at the hands of their deeply dysfunctional parents.', 210, 15, 20, 'Jeannette Walls', 'Scribner', 'English', 'the_glass_castle.png');
INSERT INTO product_category(product_id, category_type) VALUES(47, 'memoir');
INSERT INTO product(name, synopsis, price, discount, stock, author, editor, language, image) VALUES('The Brothers Karamazov', 'A novel by Fyodor Dostoevsky. It explores the themes of faith, morality, and the consequences of free will.', 240, 18, 15, 'Fyodor Dostoevsky', 'The Russian Messenger', 'Russian', 'the_brothers_karamazov.png');
